...
describe('ERC20Permit', function () {
  ...
  it('initializes DOMAIN_SEPARATOR and PERMIT_TYPEHASH correctly', async () => {
    ...
    expect(await erc20.DOMAIN_SEPARATOR()).to.be.equal(getDomainSeparator(name, erc20.address, await erc20.version(), chainId))
  })
  ...
  it('permits and emits Approval (replay safe)', async () => {
    ...
    expect(await erc20.allowance(approve.owner, approve.spender)).to.be.equal(approve.value)
